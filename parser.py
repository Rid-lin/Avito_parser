...
def main():
    ...
    print('new_data_list', len(new_data_list), new_data_list)
    ...
    print('t_wo_desc', len(t_wo_desc), t_wo_desc)
    if description:
        t_descs = get_t_desc(t_wo_desc)
        print('t_descs', len(t_descs), t_descs)
        t_with_desc = get_table_with_desc(t_wo_desc, t_descs)
        print('t_with_desc', len(t_with_desc), t_with_desc)
